<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:78:"D:\phpStudy\PHPTutorial\WWW\yubei\admin\public/../app/view\customer\index.html";i:1528637552;s:60:"D:\phpStudy\PHPTutorial\WWW\yubei\admin\app\view\layout.html";i:1525744882;s:67:"D:\phpStudy\PHPTutorial\WWW\yubei\admin\app\view\public\header.html";i:1528429378;s:65:"D:\phpStudy\PHPTutorial\WWW\yubei\admin\app\view\public\menu.html";i:1525744882;s:67:"D:\phpStudy\PHPTutorial\WWW\yubei\admin\app\view\public\footer.html";i:1525744882;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="utf-8">
                        ...
                        <div class="btn-toolbar">
                            ...
                            <form class="form-inline" style="margin-bottom:15px;" class="search-tool">
                                <span>
                                    ...
                                    <input type="text" class="form-control" placeholder="商户姓名" name="truename" value="<?php echo \think\Request::instance()->get('truename'); ?>">
                                </span>

                                <span style="margin-left: 15px;">
                                    <label class="control-label">商户编号</label>
                                    <input type="text" class="form-control" placeholder="商户编号" name="sn" value="<?php echo \think\Request::instance()->get('sn'); ?>">
                                </span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:;"
                                            ...
                                            onclick="editAjaxModal('<?php echo url('/Customer/edit/id/'.$user->uid); ?>')" >
                                            编辑
                                        </a>

                                        <a href="javascript:;" class="btn btn-danger btn-sm btn-icon icon-left" onclick="del('<?php echo $user['uid']; ?>')">
                                            删除
                                        </a>
