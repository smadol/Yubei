<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:74:"D:\phpStudy\PHPTutorial\WWW\yubei\admin\public/../app/view\user\index.html";i:1528529936;s:60:"D:\phpStudy\PHPTutorial\WWW\yubei\admin\app\view\layout.html";i:1525744882;s:67:"D:\phpStudy\PHPTutorial\WWW\yubei\admin\app\view\public\header.html";i:1528429378;s:65:"D:\phpStudy\PHPTutorial\WWW\yubei\admin\app\view\public\menu.html";i:1525744882;s:67:"D:\phpStudy\PHPTutorial\WWW\yubei\admin\app\view\public\footer.html";i:1525744882;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="utf-8">
    ...
    <div class="page-title">
        ...
        <div class="breadcrumb-env pull-left">
            ...
            <ol class="breadcrumb bc-1">
                <li>
                    <a href="<?php echo url('User/index'); ?>"><i class="fa-home"></i>首页</a>
                </li>
                <li>
                    <a href="">系统设置</a>
                 </li>
                        ...
                        <div class="btn-toolbar">
                            ...
                            <form class="form-inline" style="margin-bottom:15px;" class="search-tool">
                                <span>
                                    ...
                                    <input type="text" class="form-control" placeholder="管理姓名" name="truename" value="<?php echo \think\Request::instance()->get('truename'); ?>">
                                </span>

                                <span style="margin-left: 15px;">
                                    <label class="control-label">管理编号</label>
                                    <input type="text" class="form-control" placeholder="管理编号" name="sn" value="<?php echo \think\Request::instance()->get('sn'); ?>">
                                </span>
                                ...
                                <span style="margin-left: 15px;">
                                    ...
                                    <select class="form-control" name="status">
                                        ...
                                        <option value=" "
                                            <?php if(\think\Request::instance()->get('status') == '0'): ?> selected="selected" <?php endif; ?>>禁用</option>
                                        <option value="1"
                                            <?php if(\think\Request::instance()->get('status') == '1'): ?> selected="selected" <?php endif; ?>>启用</option>
                                    </select>
                                </span>
                                ...
                                <span style="margin-left: 15px;">
                                    ...
                                    <select class="form-control" name="role">
                                            ...
                                            <option value="<?php echo $vo['id']; ?>" <?php if(\think\Request::instance()->get('role') == $vo['id']): ?> selected="selected" <?php endif; ?>><?php echo $vo['name']; ?></option>
                                            <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </span>
                        ...
                        <table class="table table-bordered table-striped" id="example-2">
                            ...
                            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    ...
                                    <td> <?php echo $user['findRole']->name; ?> </td>
                                    ...
                                    <td>
                                        ...
                                        <a href="javascript:;" class="btn btn-danger btn-sm btn-icon icon-left" onclick="del('<?php echo $user['id']; ?>')">
                                            删除
                                        </a>
