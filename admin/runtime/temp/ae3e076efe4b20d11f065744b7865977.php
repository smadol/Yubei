<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"D:\phpStudy\PHPTutorial\WWW\yubei\admin\public/../app/view\login\index.html";i:1528427363;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<body class="page-body login-page">
            ...
            <div class="col-sm-6">
                ...
                <form method="post" role="form" id="login" class="login-form fade-in-effect">
                    ...
                    <div class="login-header">
                        <a href="/" class="logo">
                            <img src="__STATIC__/logo-white.png" alt="" width="180" />
                            <span>管理平台</span>
                        </a>
    ...
    <script src="__STATIC__/js/toastr/toastr.min.js"></script>
