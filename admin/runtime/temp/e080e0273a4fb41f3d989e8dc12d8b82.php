<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:73:"D:\phpStudy\PHPTutorial\WWW\yubei\admin\public/../app/view\user\role.html";i:1529332556;s:60:"D:\phpStudy\PHPTutorial\WWW\yubei\admin\app\view\layout.html";i:1525744882;s:67:"D:\phpStudy\PHPTutorial\WWW\yubei\admin\app\view\public\header.html";i:1528429378;s:65:"D:\phpStudy\PHPTutorial\WWW\yubei\admin\app\view\public\menu.html";i:1525744882;s:67:"D:\phpStudy\PHPTutorial\WWW\yubei\admin\app\view\public\footer.html";i:1525744882;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="utf-8">
    ...
    <div class="col-md-12">
            ...
            <div class="panel-body">
                <table class="table table-bordered table-striped" id="example-2">
                    ...
                    <tr>
                        ...
                        <td> <?php echo $role['ids']; ?> </td>
                        <td> <?php if($role['status']==0): ?>
                        ...
                        <td>
                            <a href="javascript:;"
                               ...
                               onclick="editAjaxModal('<?php echo url('/User/role_edit/id/'.$role->id); ?>')" >
                                编辑
                            </a>

                            <a href="javascript:;" class="btn btn-danger btn-sm btn-icon icon-left" onclick="del('<?php echo $role['id']; ?>')">
                                删除
                            </a>
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <div class="dataTables_info" id="example-3_info" role="status" aria-live="polite"> 共<?php echo count( $role ); ?> 行数据</div></div>
                    <div class="col-xs-6">
        ...
        <script type="text/javascript">
            ...
            function showAjaxModal(){
                ...
                jQuery.ajax({
                    url: "<?php echo url('User/role_add'); ?>",
            ...
            function add_from(){
                ...
                $.post("<?php echo url('User/role_save'); ?>", res,function(data){
                    if( data.error>0 ){
            ...
            function edit_from(){
                ...
                $.post("<?php echo url('User/role_update'); ?>", res,function(data){
                    if( data.error>0 ){
                        toastr.error( data.msg );
                    }else{
                        toastr.success( data.msg );
            ...
            function del(id){
                if( confirm("确定要删除吗？") ){
                    $.post("<?php echo url('User/role_delete'); ?>", {id:id},function(data){
                        if( data.error>0 ){
                            toastr.error( data.msg );
                        }else{
                            toastr.success( data.msg );
