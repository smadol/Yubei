<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:77:"D:\phpStudy\PHPTutorial\WWW\yubei\admin\public/../app/view\channel\index.html";i:1528537446;s:60:"D:\phpStudy\PHPTutorial\WWW\yubei\admin\app\view\layout.html";i:1525744882;s:67:"D:\phpStudy\PHPTutorial\WWW\yubei\admin\app\view\public\header.html";i:1528429378;s:65:"D:\phpStudy\PHPTutorial\WWW\yubei\admin\app\view\public\menu.html";i:1525744882;s:67:"D:\phpStudy\PHPTutorial\WWW\yubei\admin\app\view\public\footer.html";i:1525744882;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="utf-8">
...
<!-- 					<li>
                        ...
                        <div class="btn-toolbar">
                            ...
                            <form class="form-inline" style="margin-bottom:15px;" class="search-tool">
                                <span style="margin-left: 15px;">
                                    ...
                                    <input type="text" class="form-control" placeholder="渠道编号" name="sn" value="<?php echo \think\Request::instance()->get('sn'); ?>">
                                </span>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:;"
                                       ...
                                       onclick="editAjaxModal('<?php echo url('/Channel/edit/id/'.$vo->id); ?>')" >
                                        编辑
                                    </a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">添加支付渠道</h4>
                    </div>
        ...
        <div class="modal fade " id="modal-edit">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title">编辑支付渠道</h4>
                    </div>
    ...
    <script type="text/javascript">
        ...
        function showAjaxModal(){
            ...
            jQuery.ajax({
                url: "<?php echo url('Channel/create'); ?>",
        ...
        function add_from(){
            ...
            $.post("<?php echo url('Channel/save'); ?>", res,function(data){
                if( data.error>0 ){
        ...
        function edit_from(){
            ...
            $.post("<?php echo url('Channel/update'); ?>", res,function(data){
                if( data.error>0 ){
                    toastr.error( data.msg );
                }else{
                    toastr.success( data.msg );
