<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:80:"D:\phpStudy\PHPTutorial\WWW\yubei\www\public/../application/view\user\index.html";i:1528131349;s:66:"D:\phpStudy\PHPTutorial\WWW\yubei\www\application\view\layout.html";i:1526126700;s:73:"D:\phpStudy\PHPTutorial\WWW\yubei\www\application\view\common\header.html";i:1528426891;s:73:"D:\phpStudy\PHPTutorial\WWW\yubei\www\application\view\common\footer.html";i:1528130949;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        <nav class="navbar user-info-navbar" role="navigation">
            ...
            <div class="page-title">
                <div class="title-env">
                    ...
                    <p class="description">商户基本信息</p>
                </div>
                <div class="breadcrumb-env">
                    <ol class="breadcrumb bc-1">
                        <li>
                            <a href="dashboard-1.html"><i class="fa-home"></i>商户平</a>
                        </li>
                        <li>
                            <a href="extra-gallery.html">商户中心</a>
                        </li>
                        <li class="active">
                            <strong>商户信息</strong>
                        </li>
                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <form id="edit-user" method="post" role="form" class="form-horizontal">
                                    <input type="hidden" value="<?php echo \think\Request::instance()->token(); ?>" />
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">uid</label>

                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" value="<?php echo (isset($user['uid']) && ($user['uid'] !== '')?$user['uid']:'1000000'); ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group-separator"></div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">商户E-mail</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" value="<?php echo (isset($user['username']) && ($user['username'] !== '')?$user['username']:'xxxx@yubei.cn'); ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group-separator"></div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="realname" class="form-control" value="<?php echo (isset($user['realname']) && ($user['realname'] !== '')?$user['realname']:'王某人'); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group-separator"></div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="phone" class="form-control" value="<?php echo (isset($user['phone']) && ($user['phone'] !== '')?$user['phone']:'18000000000'); ?>">
                                        </div>
                                    </div>
