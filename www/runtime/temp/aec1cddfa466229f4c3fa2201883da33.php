                    ...
                    <div class="panel-heading btn-toolbar">
                        ...
                        <div class="btn-group pull-right">
                            ...
                            <ul class="dropdown-menu dropdown-success" role="menu">
                                <li>
                                    <a href="<?php echo url('user/Order/excel',['date'=> 'day']); ?>">当日对账单</a>
                                </li>
                                <li>
                                    <a href="<?php echo url('user/Order/excel',['date'=> 'month']); ?>">本月对账单</a>
                                </li>
                                <li>
                                    <a href="<?php echo url('user/Order/excel',['date'=> 'day']); ?>">本季度对账单</a>
                                </li>
                                <li class="divider"></li>
                                <li>
                                    <a href="<?php echo url('user/Order/excel',['date'=> 'day']); ?>">近半年对账单</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="btn-toolbar">
                            ...
                            <form method="get" class="form-inline search-tool" style="margin-bottom:15px;">
                                <span style="margin-left: 15px;">
                                    ...
                                    <input type="text" class="form-control" placeholder="订单编号" name="out_trade_no" value="<?php echo \think\Request::instance()->get('out_trade_no'); ?>" />
                                </span>
                                <span style="margin-left: 15px;">
                                ...
                                <span style="margin-left: 15px;">
                                    ...
                                    <select class="form-control" name="status">
                                        ...
                                        <option value="1" <?php if(\think\Request::instance()->get('status') == '1'): ?> selected="selected" <?php endif; ?>>待支付</option>
                                        <option value="2" <?php if(\think\Request::instance()->get('status') == '2'): ?> selected="selected" <?php endif; ?>>已支付</option>
                                    </select>
                                </span>
